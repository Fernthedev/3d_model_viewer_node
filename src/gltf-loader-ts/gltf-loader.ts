...
import { BINARY_HEADER_MAGIC, GLTFBinaryData } from './glb-decoder.ts';
import { GltfAsset } from './gltf-asset.ts';
import { LoaderUtils } from './loaderutils.ts';
import { LoadingManager } from './loadingmanager.ts';

// main library exports
import * as gltf from './gltf.ts';
export {gltf };
export * from './gltf-asset.ts';
export * from './loadingmanager.ts';
...
export class GltfLoader {
    ...
    private parse(data: ArrayBuffer, path: string): GltfAsset {
        let content: string;
